 ...
 */
@ContentView(R.layout.activity_tobe_recommend_cadidatefilter)
public class ToBeRecommendedCandidateFilterActivity extends BaseActivity{
    private static final int POSITION_REQUEST=1;
    private List<CityJson.DistrictsOne> zhinenglist;
    private String ageFrom="",zhineng="",ageTo="",gender="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationLayout.setCenterText(getString(R.string.advanced_search));
    ...
    private void search(View view){
        ...
        ToBeRecommendedCandidateFilterActivity.this.finish();
    }
