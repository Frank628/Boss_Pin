...
public class SharePrefUtil {
	...
	public interface KEY {
		...
		String FUNCTION_ALL_JSON = "all_function_json";//??????Funcation Json
		String FUNCTION_SELECTED_ID = "selcted_function_ids";//??�????function ids
		
		String CATE_ALL_JSON = "all_cate_json";//???????��?��??�?? Json
		String CATE_SELECTED_JSON = "selcted_cate_json";//??�?????��?��??�??ids
		String CATE_EXTEND_ID = "extend_cate_ids";//?��?????��?? ??�??ids
		
		String VOTE_SELECTED_ID = "selcted_vote_ids";//??�????function ids
	}
