...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        mUnderlineColor = ContextCompat.getColor(getContext(), R.color.main_nav_bg);
        mDividerColor = ContextCompat.getColor(getContext(), R.color.main_nav_bg);
        mIndicatorColor = ContextCompat.getColor(getContext(), R.color.main_nav_bg);
...
//                tab_title.setTextColor(mTabTextColor);
                tab_title.setTextColor(ContextCompat.getColor(getContext(), R.color.title2));
    ...
    private void select(View tab) {
        if (tab != null) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextColor(ContextCompat.getColor(getContext(), R.color.main_nav_bg));
            }
