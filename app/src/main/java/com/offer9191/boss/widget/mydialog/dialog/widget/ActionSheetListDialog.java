 ...
 */
public class ActionSheetListDialog extends BottomBaseDialog {
    /**
     * ListView
     */
    private ListView lv;
...
//    private TextView tv_cancel;
    ...
    public ActionSheetListDialog(Context context, ArrayList<DialogMenuItem> baseItems, View animateView) {
        super(context, animateView);
        this.contents.addAll(baseItems);
        init();
    }

    public ActionSheetListDialog(Context context, String[] items, View animateView) {
        super(context, animateView);
    ...
    public ActionSheetListDialog(Context context, BaseAdapter adapter, View animateView) {
        super(context, animateView);
...
//        });
     ...
     */
    public ActionSheetListDialog titleBgColor(int titleBgColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog title(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog titleHeight(float titleHeight) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog titleTextSize_SP(float titleTextSize_SP) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog titleTextColor(int titleTextColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog isTitleShow(boolean isTitleShow) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog lvBgColor(int lvBgColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog cornerRadius(float cornerRadius_DP) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog dividerColor(int dividerColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog dividerHeight(float dividerHeight_DP) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog itemPressColor(int itemPressColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog itemTextColor(int itemTextColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog itemTextSize(float itemTextSize_SP) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog itemHeight(float itemHeight_DP) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetListDialog layoutAnimation(LayoutAnimationController lac) {
        this.lac = lac;
        return this;
    }
