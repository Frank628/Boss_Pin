package com.offer9191.boss.widget.mydialog.dialog.widget;
...
import com.offer9191.boss.widget.mydialog.dialog.entity.DialogMenuItem;
import com.offer9191.boss.widget.mydialog.dialog.listener.OnOperItemClickL;
import com.offer9191.boss.widget.mydialog.dialog.utils.CornerUtils;
import com.offer9191.boss.widget.mydialog.dialog.widget.base.BottomBaseDialog;
 ...
 */
public class ActionSheetDialogWechat extends BottomBaseDialog {
    /**
     * ListView
     */
    private ListView lv;
...
//    private TextView tv_cancel;
     ...
     */
    private float cornerRadius_DP = 0;
    /**
     ...
     */
    private int itemTextColor = Color.parseColor("#666666");
    /**
    ...
    public ActionSheetDialogWechat(Context context, ArrayList<DialogMenuItem> baseItems, View animateView) {
        super(context, animateView);
        this.contents.addAll(baseItems);
        init();
    }

    public ActionSheetDialogWechat(Context context, String[] items, View animateView) {
        super(context, animateView);
    ...
    public ActionSheetDialogWechat(Context context, BaseAdapter adapter, View animateView) {
        super(context, animateView);
...
//        });
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (onOperItemClickL != null) {
                    ...
                    ActionSheetDialogWechat.this.dismiss();
                }
            }
        });
     ...
     */
    public ActionSheetDialogWechat titleBgColor(int titleBgColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat title(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat titleHeight(float titleHeight) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat titleTextSize_SP(float titleTextSize_SP) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat titleTextColor(int titleTextColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat isTitleShow(boolean isTitleShow) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat lvBgColor(int lvBgColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat cornerRadius(float cornerRadius_DP) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat dividerColor(int dividerColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat dividerHeight(float dividerHeight_DP) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat itemPressColor(int itemPressColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat itemTextColor(int itemTextColor) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat itemTextSize(float itemTextSize_SP) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat itemHeight(float itemHeight_DP) {
     ...
     * @return ActionSheetDialog
     */
    public ActionSheetDialogWechat layoutAnimation(LayoutAnimationController lac) {
        this.lac = lac;
        return this;
    }
